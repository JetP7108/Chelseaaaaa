...
module.exports.run = async ({ api, event, args, client, utils }) => {
	...
	if (args[0] == "1") {
		return api.sendMessage("==== master 1 ====\nTên: Hoàng Đỗ Gia Nguyên\nLiên hệ:\nhttps://www.facebook.com/profile.php?id=100065446177481,Zalo:0335953652", event.threadID, event.messageID);
	}
	else if (args[0] == "2") {
		return api.sendMessage("==== master 2 ====\nTên: Hoàng Đỗ Gia Nguyên(Shiron)\nLiên hệ:\nhttps://www.facebook.com/HoangDoGiaNguyen.Official,Zalo:0335953652", event.threadID, event.messageID);
	}
}