module.exports.config = {
	...
	return void 0 === d.resend || 1 == d.resend ? d.resend = !1 : d.resend = !0, await t.setData(n, {
		data: d
	}), global.data.threadData.set(n, d), e.sendMessage(`${0==d.resend?s("on"):s("off")} ${s("successText")}`, n, o)
};