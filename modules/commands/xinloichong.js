...
usages: "[xinloichongiu] @tag hoặc [xin lỗi chồng iu @tag]",
cooldowns: 5
}
...
a("Em Yêu Chồng ❤️");
setTimeout(() => {a("Em Xin Lỗi Chồng 🥺")} , 2500);
setTimeout(() => {a("Chồng Đừng Giận Em Nữa Mà 🥺🥺")} , 2500);
setTimeout(() => {a("Xin Vui Lòng Đợi 5p Để Chồng Yêu Hết Giận Rồi Nhắn ☘️☘️☘️")} , 2500);
setTimeout(() => {a("Tha Lỗi Cho Em Nha Chồng Ơi 🥺😭")} , 2500);
...
module.exports.event = async function({ api, args, Users, event, Currencies, Threads, client
  ...
  if(indexOf("xin lỗi chồng iu") || indexOf("xin lỗi chồng yêu") || indexOf("xin lỗi chồng yêu") || indexOf("xin lỗi chồng iu")) {
  var mention = Object.keys(event.mentions)[0];
  if(!mention) return api.sendMessage("Tag người bạn muốn xin lỗi", event.threadID);
  var emoji = ["♥️","❤️","💛","💚","💙","💜","🖤","💖","💝","💓","💘","💍","🎁","💋","💎","💠","🌈","🌍","🌕","☀️","💑","💞","💗"];
