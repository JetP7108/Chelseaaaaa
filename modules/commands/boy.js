...
module.exports.run = async ({ api, event, Currencies }) => {
	...
	} else return api.sendMessage("Bạn cần 1000 đô để dùng lệnh này, hãy dụng lệnh: !daily, !work để thu thập đô hoặc có thể đi xin admin bot nhé <3",event.threadID,event.messageID);
}
